...
<body class="bg-light">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-3 px-md-4 py-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 border-bottom gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0">Manage your follow up sellers</p>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="workstation_add_seller.php" class="btn btn-primary">
                            <i class="bi bi-plus-circle me-1"></i>Add New Seller
                        </a>
                        <a href="workstation_dashboard.php" class="btn btn-outline-secondary">
                    ...
                    <div class="collapse show" id="filterCollapse">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <label class="form-label small fw-bold">Seller Type</label>
                                    <select class="form-select form-select-sm" id="filterSellerType">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                            <h5 class="card-title mb-0">Follow Up Sellers List</h5>
    ...
    <script src="<?= BASE_URL ?>js/work-station/follow-ups/workstation_followup_list.js"></script>
