                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body p-4">
                                <form id="sellerForm" data-seller-id="<?= $seller_id ?>">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3 mb-md-0">
                                            ...
                                            <select class="form-select" id="sellerType">
                                                ...
                                                <option value="Organic Seller" <?= $form_data['seller_type'] == 'Organic Seller' ? 'selected' : '' ?>>Organic Seller</option>
                                                <option value="Direct Seller" <?= $form_data['seller_type'] == 'Direct Seller' ? 'selected' : '' ?>>Direct Seller</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">
                                    ...
                                    <!-- Dynamic Fields Container (Plan Details, Call Back, Schedule, Refund) -->
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 mb-3 mb-md-0">
                                            ...
                                            <textarea class="form-control" rows="3"
                                                ...
                                                id="rememberingNotes"><?= htmlspecialchars($form_data['remembering_notes']) ?></textarea>
                                        </div>
                                        <div class="col-md-4 mb-3 mb-md-0">
                                            <label class="form-label fw-semibold">
                                            ...
                                            <textarea class="form-control" rows="3"
                                                ...
                                                id="customerQueries"><?= htmlspecialchars($form_data['customer_queries']) ?></textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">
                                            ...
                                            <textarea class="form-control" rows="3"
                                                ...
                                                id="additionalNotes"><?= htmlspecialchars($form_data['remarks']) ?></textarea>
                                        </div>
                                    </div>

                                    <!-- 3x3 Grid Layout - Row 4 -->
                                    <div class="row mb-4">
                                        <div class="col-md-4 mb-3 mb-md-0">
                                            <label class="form-label fw-semibold">
                                            ...
                                            <select class="form-select" id="callTimingSelect">
                                            ...
                                            <div id="customCallTimingContainer" style="display: none;" class="mt-2">
                                                <input type="text" class="form-control" id="customCallTiming"
