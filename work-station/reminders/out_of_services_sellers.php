...
// Build query for Out of Service sellers
$count_sql = "SELECT COUNT(*) FROM sales_person_sellers 
              WHERE user_uid = ? AND customer_response = 'Out of Service'";
...
<head>
    ...
    <title>Out of Service Sellers - Work Station</title>
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 border-bottom gap-2">
                    <div>
                        <h1 class="h2 mb-1">
                            ...
                            Out of Service Sellers
                        </h1>
                        <p class="text-muted mb-0">
                            <i class="bi bi-info-circle me-1"></i>
                            Total: <?= $total_records ?> sellers with out of service numbers
                        </p>
                    </div>
                                    ...
                                    <div class="col-12 col-md-2">
                                        <div class="d-grid gap-2 d-md-flex">
                                            ...
                                            <?php if (!empty($search) || !empty($from_date) || !empty($to_date)): ?>
                                                <a href="out_of_services_sellers.php" class="btn btn-outline-secondary">
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center py-5">
                                                        <div class="py-4">
                                                            ...
                                                            <h5 class="text-muted mb-2">No Out of Service Sellers Found</h5>
                                                            <p class="text-muted mb-3">
                                                                <?php if (!empty($search) || !empty($from_date) || !empty($to_date)): ?>
                                                                    Try changing your filter criteria
                                                                <?php else: ?>
                                                                    No out of service records available
                                                                <?php endif; ?>
                                                            </p>
                                                            <?php if (!empty($search) || !empty($from_date) || !empty($to_date)): ?>
                                                                <a href="out_of_services_sellers.php" class="btn btn-outline-secondary">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" id="editFromModal" class="btn btn-dark">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div><span class="badge bg-dark">${escapeHtml(seller.customer_response || 'N/A')}</span></div>
                                </div>
                                <div class="col-md-6 mb-3">
