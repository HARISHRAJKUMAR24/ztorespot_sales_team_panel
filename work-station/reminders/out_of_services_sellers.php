...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-dark px-3 py-2 fs-6">
                                <i class="bi bi-exclamation-triangle me-1"></i> Out of Service
                            </span>
                            <h1 class="h2 mb-0">Out of Service Numbers</h1>
                        </div>
                        <p class="text-muted mb-0">Sellers whose numbers are out of service</p>
                    </div>
                        ...
                        <div class="card bg-dark bg-opacity-10 border-dark h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-dark mb-2">Total Out of Service</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Inactive numbers</small>
                                    </div>
                                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                                        <i class="bi bi-exclamation-triangle fs-1 text-dark"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">Added this week</small>
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-warning bg-opacity-10 border-warning h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-warning mb-2">This Month</span>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading out of service data...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            <i class="bi bi-exclamation-triangle fs-1 text-dark opacity-50"></i>
                            <h5 class="mt-3 text-muted">No Out of Service Records Found</h5>
                            <p class="text-muted">Sellers with out of service numbers will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
   ...
   <script src="<?= BASE_URL ?>js/work-station/reminders/out_of_services_sellers.js"></script>
