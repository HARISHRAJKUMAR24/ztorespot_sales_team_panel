...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-secondary px-3 py-2 fs-6">
                                <i class="bi bi-power me-1"></i> Switch Off
                            </span>
                            <h1 class="h2 mb-0">Switched Off Numbers</h1>
                        </div>
                        <p class="text-muted mb-0">Sellers whose phones are switched off</p>
                    </div>
                        ...
                        <div class="card bg-secondary bg-opacity-10 border-secondary h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-secondary mb-2">Total Switch Off</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Switched off numbers</small>
                                    </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading switch off data...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            <i class="bi bi-power fs-1 text-secondary opacity-50"></i>
                            <h5 class="mt-3 text-muted">No Switch Off Records Found</h5>
                            <p class="text-muted">Sellers with switched off phones will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <style>
        ...
        .sortable:hover { background-color: rgba(108, 117, 125, 0.1) !important; }
    ...
    <script src="<?= BASE_URL ?>js/work-station/reminders/switchoff_sellers.js"></script>
