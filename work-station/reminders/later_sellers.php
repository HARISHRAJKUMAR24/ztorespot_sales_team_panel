...
if (isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'get_data') {
        try {
            ...
            // Build query - Only Later responses
            $where = "WHERE user_uid = ? AND customer_response = 'Later'";
            $params = [$user_uid];
            ...
            // Get stats for Later only
            $stats_sql = "SELECT 
                COUNT(*) as total,
                SUM(CASE WHEN current_status = 'Not yet' THEN 1 ELSE 0 END) as pending_count,
                SUM(CASE WHEN current_status = 'In Progress' THEN 1 ELSE 0 END) as progress_count,
                SUM(CASE WHEN current_status = 'Upgraded' THEN 1 ELSE 0 END) as upgraded_count
                FROM sales_person_sellers WHERE user_uid = ? AND customer_response = 'Later'";
    ...
    if ($_POST['action'] === 'delete') {
        try {
            $id = intval($_POST['id']);
            $stmt = $pdo->prepare("DELETE FROM sales_person_sellers WHERE id = ? AND user_uid = ? AND customer_response = 'Later'");
...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-warning px-3 py-2 fs-6">
                                <i class="bi bi-clock-history me-1"></i> Later
                            </span>
                            <h1 class="h2 mb-0">Call Back Later</h1>
                        </div>
                        ...
                        <div class="card bg-warning bg-opacity-10 border-warning h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-warning mb-2">Total Later</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Sellers waiting</small>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2 class="mb-0" id="progressCount">0</h2>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading later calls...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            ...
                            <h5 class="mt-3 text-muted">No Later Calls Found</h5>
                            <p class="text-muted">All later call sellers will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <style>
        ...
        .sortable:hover { background-color: rgba(255, 193, 7, 0.1) !important; }
    ...
    $(document).ready(function () {
        ...
        function renderPagination(total, page, perPage) {
            ...
            if (totalPages > 1) {
                html += `<li class="page-item ${page === 1 ? 'disabled' : ''}">
                    <a class="page-link bg-warning text-white border-warning" href="#" data-page="${page - 1}">&laquo;</a>
                </li>`;
                
                for (let i = 1; i <= totalPages; i++) {
                    if (i === 1 || i === totalPages || (i >= page - 2 && i <= page + 2)) {
                        html += `<li class="page-item ${i === page ? 'active' : ''}">
                            <a class="page-link ${i === page ? 'bg-warning text-white border-warning' : 'text-warning'}" 
                ...
                html += `<li class="page-item ${page === totalPages ? 'disabled' : ''}">
                    <a class="page-link bg-warning text-white border-warning" href="#" data-page="${page + 1}">&raquo;</a>
                </li>`;
            }
        ...
        function updateStats(stats) {
            ...
            $('#progressCount').text(stats.progress_count || 0);
