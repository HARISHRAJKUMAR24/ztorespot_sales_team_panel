...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-dark px-3 py-2 fs-6">
                                <i class="bi bi-briefcase-slash me-1"></i> No Business
                            </span>
                            <h1 class="h2 mb-0">No Business Sellers</h1>
                        </div>
                        <p class="text-muted mb-0">Sellers who are not operating or have no business</p>
                    </div>
                        ...
                        <div class="card bg-dark bg-opacity-10 border-dark h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-dark mb-2">Total No Business</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Inactive businesses</small>
                                    </div>
                                    <div class="bg-dark bg-opacity-25 p-3 rounded-circle">
                                        <i class="bi bi-briefcase-slash fs-1 text-dark"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-secondary bg-opacity-10 border-secondary h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-secondary mb-2">This Week</span>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-danger bg-opacity-10 border-danger h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-danger mb-2">This Month</span>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Business Status</label>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-briefcase-slash text-dark me-2"></i>
                                No Business List
                            </h5>
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading no business data...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            <i class="bi bi-briefcase-slash fs-1 text-dark opacity-50"></i>
                            <h5 class="mt-3 text-muted">No Business Records Found</h5>
                            <p class="text-muted">Sellers with no business will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <style>
        ...
        .sortable:hover { background-color: rgba(33, 37, 41, 0.1) !important; }
    ...
    <script src="<?= BASE_URL ?>js/work-station/reminders/no_business_sellers.js"></script>
