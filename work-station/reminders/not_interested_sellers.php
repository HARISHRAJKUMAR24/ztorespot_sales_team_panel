...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-warning px-3 py-2 fs-6">
                                <i class="bi bi-hand-thumbs-down me-1"></i> Not Interested
                            </span>
                            <h1 class="h2 mb-0">Not Interested Sellers</h1>
                        </div>
                        <p class="text-muted mb-0">Sellers who declined or showed no interest</p>
                    </div>
                        ...
                        <div class="card bg-warning bg-opacity-10 border-warning h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-warning mb-2">Total Not Interested</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Declined sellers</small>
                                    </div>
                                    <div class="bg-warning bg-opacity-25 p-3 rounded-circle">
                                        <i class="bi bi-hand-thumbs-down fs-1 text-warning"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-danger bg-opacity-10 border-danger h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-danger mb-2">This Week</span>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-secondary bg-opacity-10 border-secondary h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-secondary mb-2">This Month</span>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Reason Filter</label>
                                <select class="form-select form-select-sm" id="reasonFilter">
                                    <option value="">All Reasons</option>
                                    <option value="price">Price too high</option>
                                    <option value="competitor">Using competitor</option>
                                    <option value="not_need">Don't need</option>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-hand-thumbs-down text-warning me-2"></i>
                                Not Interested List
                            </h5>
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading not interested data...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            <i class="bi bi-hand-thumbs-down fs-1 text-warning opacity-50"></i>
                            <h5 class="mt-3 text-muted">No Not Interested Records Found</h5>
                            <p class="text-muted">Sellers who declined will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <script src="<?= BASE_URL ?>js/work-station/reminders/not_interested_sellers.js"></script>
