...
<body class="bg-light">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-success px-3 py-2 fs-6">
                                <i class="bi bi-arrow-up-circle-fill me-1"></i> Plan Upgraded
                            </span>
                            <h1 class="h2 mb-0">Upgraded Sellers</h1>
                        </div>
                        ...
                        <div class="card bg-success bg-opacity-10 border-success h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-success mb-2">Total Upgraded</span>
                                        <h2 class="mb-0" id="totalCount">0</h2>
                                        <small class="text-muted">Upgraded sellers</small>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">Upgraded this week</small>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">Upgraded this month</small>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-warning bg-opacity-10 border-warning h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="badge bg-warning mb-2">Total Products</span>
                                        <h2 class="mb-0" id="totalProducts">0</h2>
                                        <small class="text-muted">Products uploaded</small>
                                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select form-select-sm" id="planFilter">
                                    ...
                                    <option value="other">Custom Plans</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-0 p-md-3">
                        ...
                        <div id="loadingSpinner" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">Loading upgraded sellers...</p>
                        </div>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            <i class="bi bi-arrow-up-circle fs-1 text-success opacity-50"></i>
                            <h5 class="mt-3 text-muted">No Upgraded Sellers Found</h5>
                            <p class="text-muted">Sellers who upgraded their plans will appear here</p>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <script src="<?= ASSETS_URL ?>dist/js/bootstrap.bundle.min.js"></script>
     <script src="<?= BASE_URL ?>js/work-station/reminders/upgrade_sellers.js"></script>
