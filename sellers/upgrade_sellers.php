...
<body class="bg-light">
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-3 px-md-4 py-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 border-bottom gap-2">
                    <h1 class="h2 mb-2 mb-sm-0">Upgrade Sellers</h1>
                    <div class="d-flex gap-2 w-100 w-sm-auto">
                        <a href="upgrade-sellers-bulk-upload.php" class="btn btn-success flex-fill flex-sm-grow-0">
                            <i class="bi bi-cloud-upload me-1"></i><span class="d-none d-sm-inline">Bulk Upload</span><span class="d-sm-none">Upload</span>
                        </a>
                ...
                <div class="row g-3 mb-4">
                        ...
                        <div class="card text-white bg-primary h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">Total Sellers</h6>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card text-white bg-success h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">Active Plans</h6>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card text-white bg-warning h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">This Month</h6>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card text-white bg-info h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">Has Products</h6>
                                    <h3 class="mb-0" id="productsCount">0</h3>
                                </div>
                    ...
                    <div class="collapse show" id="filterCollapse">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6 col-md-2">
                                    <label class="form-label small fw-bold">Has Products</label>
                                    <select class="form-select form-select-sm" id="filterProducts">
                                        <option value="">All</option>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                            <h5 class="card-title mb-0">Upgrade Sellers List</h5>
                    ...
                    <div class="card-body p-0 p-md-3">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sortable d-none d-lg-table-cell" data-sort="store_id">Store ID <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable" data-sort="seller_name">Seller Name <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-xl-table-cell" data-sort="seller_contact">Contact <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable" data-sort="phone_number">Phone <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-lg-table-cell" data-sort="plan_name">Plan <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-md-table-cell" data-sort="plan_status">Status <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-xl-table-cell" data-sort="product_uploads">Products <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-xxl-table-cell" data-sort="assigned_by">Assigned <i class="bi bi-arrow-down-up ms-1"></i></th>
                        ...
                        <div id="noData" class="text-center py-5" style="display: none;">
                            ...
                            <p class="mt-2 text-muted">No upgrade sellers found</p>
                        </div>
                    </div>
                </div>
            </main>
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editStoreId">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Seller Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="editSellerName" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Seller Contact</label>
                            <input type="text" class="form-control" id="editSellerContact">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Seller Response</label>
                            <input type="text" class="form-control" id="editSellerResponse">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Product Uploads</label>
                            <input type="number" class="form-control" id="editProductUploads" min="0">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Plan Name</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Platform Come</label>
                            <input type="text" class="form-control" id="editPlatformCome">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Platform Known</label>
                            <textarea class="form-control" id="editPlatformKnown" rows="2"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Month Name</label>
                            <input type="text" class="form-control" id="editMonthName">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
    ...
    <script src="<?= BASE_URL ?>js/sellers/upgrade_sellers.js"></script>
