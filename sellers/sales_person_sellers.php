...
<body class="bg-light">
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-3 px-md-4 py-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 border-bottom gap-2">
                    <h1 class="h2 mb-2 mb-sm-0">Sales Person Sellers</h1>
                    <div class="d-flex gap-2 w-100 w-sm-auto">
                        <a href="sales_person_sellers.php" class="btn btn-success flex-fill flex-sm-grow-0">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card text-white bg-success h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">Registered</h6>
                                    <h3 class="mb-0" id="registeredCount">0</h3>
                                </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card text-white bg-warning h-100">
                            <div class="card-body d-flex flex-column flex-sm-row justify-content-between align-items-center p-3">
                                <div class="text-center text-sm-start mb-2 mb-sm-0">
                                    <h6 class="card-title mb-1 small">Upgraded</h6>
                                    <h3 class="mb-0" id="upgradedCount">0</h3>
                                </div>
                                <i class="bi bi-star fs-2 opacity-50"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6 col-md-2">
                                    ...
                                    <select class="form-select form-select-sm" id="filterRegStatus">
                                        ...
                                        <option value="No">Not Registered (No)</option>
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6 col-md-2">
                                ...
                                <div class="col-12 col-sm-6 col-md-2">
                                    <label class="form-label small fw-bold">Plans Interested</label>
                                ...
                                <div class="col-12 col-sm-6 col-md-2">
                                    <label class="form-label small fw-bold">Has Response</label>
                                    <select class="form-select form-select-sm" id="filterHasResponse">
                                        <option value="">All</option>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sortable" data-sort="work_details_update">Seller/Store <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-lg-table-cell" data-sort="source_type">Source <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable" data-sort="phone_number">Phone <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-xl-table-cell" data-sort="plans_interested">Plan <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th>Response</th>
                                            <th class="sortable d-none d-lg-table-cell" data-sort="current_status">Status <i class="bi bi-arrow-down-up ms-1"></i></th>
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Seller/Store Name</label>
                                <input type="text" class="form-control" id="editWorkDetails" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Plans Interested</label>
                                <select class="form-select" id="editPlansInterested">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="editCustomerResponse" rows="2"></textarea>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Remembering Notes</label>
                            <textarea class="form-control" id="editRememberingNotes" rows="2"></textarea>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Latest Update</label>
                                <input type="text" class="form-control" id="editLatestUpdate">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Current Status</label>
                                <select class="form-select" id="editCurrentStatus">
                                    <option value="">Select Status</option>
                                    <option value="Not yet">Not yet</option>
                                    <option value="Upgraded">Upgraded</option>
                                    <option value="In Active">In Active</option>
                        ...
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Customer Queries</label>
                            <textarea class="form-control" id="editCustomerQueries" rows="2"></textarea>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Video/Canva Link</label>
                                <input type="text" class="form-control" id="editVideoCanva">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold">Call Timing</label>
                                <input type="text" class="form-control" id="editCallTiming">
                            </div>
                        </div>
    ...
    <script src="<?= BASE_URL ?>js/sellers/sales_person_sellers.js"></script>
