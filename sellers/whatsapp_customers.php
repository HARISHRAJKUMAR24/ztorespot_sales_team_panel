            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-3 px-md-4 py-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 border-bottom gap-2">
                    ...
                    <div class="d-flex gap-2 w-100 w-sm-auto">
                        <a href="bulk-upload/bulk_upload_whatsapp_customers.php" class="btn btn-success flex-fill flex-sm-grow-0">
                            ...
                            <div class="d-flex flex-column flex-sm-row gap-2 w-100 w-md-auto">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="searchInput" 
                                           placeholder="Search by name, phone, seller ID...">
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="sortable" data-sort="seller_name">Seller <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable" data-sort="phone_number">Phone <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-md-table-cell" data-sort="seller_id">Seller ID <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            <th class="sortable d-none d-lg-table-cell" data-sort="store_name">Store <i class="bi bi-arrow-down-up ms-1"></i></th>
                                            ...
                                            <th class="d-none d-sm-table-cell">Assigned By</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Seller ID</label>
                            <input type="text" class="form-control" id="editSellerId">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Status</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editUpdate1">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Update 2</label>
                            <input type="text" class="form-control" id="editUpdate2">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Update 3</label>
                            <input type="text" class="form-control" id="editUpdate3">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
