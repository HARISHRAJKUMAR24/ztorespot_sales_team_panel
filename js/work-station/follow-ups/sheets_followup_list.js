$(document).ready(function () {
    ...
    function loadData() {
        ...
        $.ajax({
            url: BASE_URL + 'ajax/work-station/follow-ups/get_sheets_followup_list.php',
            type: 'POST',
            data: {
                page: currentPage,
                per_page: perPage,
    ...
    function renderTable(rows) {
        ...
        rows.forEach(function (row) {
            ...
            html += `<td class="d-none d-lg-table-cell">${escapeHtml(row.call_timing || '-')}</td>`;
    ...
    $(document).on('click', '.view-btn', function () {
        ...
        $.ajax({
            url: BASE_URL + 'ajax/work-station/follow-ups/get_sheets_seller_details.php',
            type: 'POST',
            data: { id: id },
            dataType: 'json',
            success: function (response) {
    ...
    $(document).on('click', '.delete-btn', function () {
        ...
        if (confirm('Are you sure you want to delete this seller?')) {
            $.ajax({
                url: BASE_URL + 'ajax/work-station/follow-ups/delete_sheets_seller.php',
                type: 'POST',
                data: { id: id },
                dataType: 'json',
                success: function (response) {
